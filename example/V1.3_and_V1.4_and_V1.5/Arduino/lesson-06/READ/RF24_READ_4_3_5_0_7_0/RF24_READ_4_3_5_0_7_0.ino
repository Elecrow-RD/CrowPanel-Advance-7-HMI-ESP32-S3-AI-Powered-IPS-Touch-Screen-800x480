...
*/
/** @brief Render the latest receiver status in a full-screen sprite. */
...
/** @brief Initialize board power, LCD, HSPI and the nRF24L01 receiver. */
void setup() {
  Serial.begin(115200);
...
int i=0;
/** @brief Read available radio payloads and show the received text. */
void loop() {                                                                 
