...
This is a simple example of displaying “Hello world” in the serial debugging window using ESP32 version 3.3.8.

***\*Note: All subsequent examples run on ESP32 version 3.3.8. LVGL examples use LVGL 9.1.0.\****
