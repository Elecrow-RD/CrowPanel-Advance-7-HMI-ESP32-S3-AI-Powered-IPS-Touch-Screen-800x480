...
//  lgfx::Light_PWM _light_instance;
  ...
  void beginBackBufferDraw(void)
  {
    _panel_instance.bindFrameBuffer(_bus_instance.getBackBuffer());
  }

  void commitBackBuffer(void)
  {
    _bus_instance.requestFlip();
    _panel_instance.syncFrameBuffer();
    _bus_instance.waitVSync(100);
  }
};
