...
#if !defined(MBEDTLS_KEY_EXCHANGE_PSK_ENABLED) && !defined(MBEDTLS_KEY_EXCHANGE_DHE_PSK_ENABLED) && !defined(MBEDTLS_KEY_EXCHANGE_RSA_PSK_ENABLED) && !defined(MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED)
#warning \
